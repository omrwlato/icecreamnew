            ...
            {show ? (
              <div>
                ...
                <Grid
                  ...
                  style={{ display: 'flex', marginBottom: '5px', marginTop: '10px' }}
                >
                ...
                <Grid>
                  <h3
                    style={{ color: 'black', marginBottom: '10px', marginTop: '15px' }}
                  >{`${bank.earnTokenName} EARNED`}</h3>
                </Grid>
                <Grid
                ...
                >
                  <Grid>
                    ...
                    <h5
                      style={{ color: 'grey', marginTop: '5px', marginBottom: '15px', fontWeight: 'normal' }}
                    >{`≈ $${earnedInDollars}`}</h5>
                  </Grid>
                  <Button
                    onClick={onReward}
                        ...
                        <Grid container justifyContent="space-between" alignItems="flex-start" flex spacing={2}>
                          <Grid item>
                            <h2 style={{ color: 'black' }}>
                              {console.log(bank.depositToken.decimal, stakedBalance)}
